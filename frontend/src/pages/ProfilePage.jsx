...
import { User, FileImage, Loader2, AlertTriangle, CheckCircle2, HelpCircle, Info } from 'lucide-react';
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center">
                <div className="bg-muted rounded-full p-4 md:p-6 mr-6">
                  <User className="h-8 w-8 md:h-12 md:w-12 text-mushroom-primary" />
                </div>
